...
<form class="row g-3" action="" method="post">
  ...
  <button class="btn btn-success rounded-1" name="publish_result">Check Details</button>
</form>
...
//*****************************Internal Marks
  ...
  for ($a = 0; $a < $student_count; $a++) {
    ...
    while ($row = $student_sql -> fetch_array(MYSQLI_ASSOC)) {
      ...
      <tr>
      <td>".$count."</td>
      <td><input type='text' class='form-control' style='width:100px' name='id[]' value=".$row['student_id']." disabled></td>
      <td><input type='text' class='form-control' style='width:auto' name='student_name[]' value=\"{$row['student_name']}\" disabled></td>
      ";
      
      echo "<td><input type='text' class='form-control' style='width:100px' name='marks[]' value=".$marks[$a]."></td>";
      echo "<td><input type='text' class='form-control' style='width:100px' name='internal[]' value=".$internal[$a]."></td>";
      echo "<td><input type='text' class='form-control' style='width:100px' name='practical[]' value=".$practical[$a]."></td>";
    } 
  }

  echo "<button class='btn btn-success rounded-1' name='save'>Save</button>";
  echo '</table></form>';
