        ...
        <nav class="side-navbar">
          <div class="side-navbar-wrapper">
            ...
            <div class="sidenav-header d-flex align-items-center justify-content-center">
              ...
              <div class="sidenav-header-logo"><a href="main_dashboard.php" class="brand-small text-center"> <strong>L</strong><strong class="text-primary">V</strong></a></div>
            </div>
            ...
            <div class="main-menu">
              ...
              <ul id="side-main-menu" class="side-menu list-unstyled">                  
                ...
                if ($db_teacher_role == 'Principle' || $db_teacher_role == 'classTeacher' ) {
                  echo "<li><a href='add_student_ui.php'> <i class='fa fa-bar-chart'></i>Add Student</a></li>";
                  if ($db_teacher_role == 'Principle') {
                    echo "<li><a href='add_teacher_ui.php'> <i class='icon-grid'></i>Add Teacher</a></li>
                    ";
                  }
                }
                ?>
                ...
                <?php 
                if ($db_teacher_role == 'Principle' || $db_teacher_role == 'classTeacher' ) {
                  echo "<li><a href='edit_student_form_ui.php'> <i class='icon-interface-windows'></i>Edit Student Details</a></li>";
                  if ($db_teacher_role == 'Principle') {
                    echo "<li><a href='edit_teacher_ui.php'> <i class='icon-interface-windows'></i>Edit Teacher Details</a></li>
                    ";
                  }
                }
                ?>
              ...
              <div class="container-fluid">
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                  <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a>
                    <a href="main_dashboard.php" class="navbar-brand">
